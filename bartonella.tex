...
\twocolumn[
	...
	\begin{abstract}
		...
		Cases were 2.1 times more likely to be seropositive for \emph{Bartonella sp.} (p \textless 0.05), and housing status and geographical location were found to modify this effect, possibly due to association with flea exposure.
